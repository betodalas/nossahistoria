    ...
    <div className="min-h-screen flex flex-col" style={{background:'linear-gradient(160deg,#0f0a1a,#1a0535,#2d1060)'}}>
      ...
      {step === 0 && (
        <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
          ...
          <p className="text-sm text-white/40 mb-10">{weddingDate}</p>
      ...
      {step === 1 && (
        <div className="flex-1 flex flex-col">
          <div className="px-4 pt-8 pb-4 text-center">
            <p className="text-xs text-white/40 uppercase tracking-widest mb-1">Nossa jornada até aqui</p>
          ...
          {moments.length === 0 ? (
            <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
              ...
              <p className="text-xs text-white/30 mt-2">Mas a história de vocês está apenas começando 💜</p>
            ...
            <div className="flex-1 px-4">
              ...
              <div className="flex items-center justify-between mt-4 mb-4">
                ...
                <p className="text-xs text-white/40">{currentMoment+1} de {moments.length}</p>
      ...
      {step === 2 && (
        <div className="flex-1 flex flex-col items-center justify-center p-6">
          ...
          <p className="text-xs text-white/40 mb-6 text-center">Escritas antes deste dia</p>
          {myLetter ? (
            ...
            <div className="w-full rounded-2xl p-5 mb-4 border border-white/10 text-center" style={{background:'rgba(255,255,255,0.05)'}}>
              <p className="text-sm text-white/30">Você não escreveu uma carta para hoje</p>
            </div>
          )}
